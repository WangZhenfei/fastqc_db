...
WHERE (module_stats.overall = 'fail'
OR module_stats.per_base_sequence_content = 'fail'
OR module_stats.per_tile_sequence_quality = 'fail'
OR module_stats.per_sequence_quality_scores = 'fail'
OR module_stats.per_base_sequence_content = 'fail'
OR module_stats.per_sequence_gc_content = 'fail'
OR module_stats.per_base_n_content = 'fail'
OR module_stats.sequence_length_distribution = 'fail'
OR module_stats.sequence_duplication_levels = 'fail'
OR module_stats.overrepresented_sequences = 'fail'
OR module_stats.adapter_content = 'fail'
OR module_stats.kmer_content = 'fail')
